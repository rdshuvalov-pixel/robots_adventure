  ...
  bugHunt: {
    ...
    rounds: [
      ...
      },
      {
        ...
        title: "Мытье рук",
        type: "bug-hunt",
        note: "Иногда инструкция ломается не в начале, а в самом конце.",
        steps: ["Включи воду.", "Намыль руки.", "Смой пену.", "Вытри руки."],
        detectPrompt: "Посмотри внимательно: не забыли ли мы что-то важное в конце?",
        detectOptions: [
          "Забыли выключить воду.",
          "Нужно сначала спеть песню.",
          "Руки нужно мыть только одной рукой."
        ],
        detectCorrectIndex: 0,
        fixPrompt: "Какую версию плана лучше дать роботу?",
        fixOptions: [
          "Включи воду -> Намыль руки -> Смой пену -> Выключи воду -> Вытри руки",
          "Включи воду -> Вытри руки -> Намыль руки",
          "Намыль руки -> Уходи -> Смой пену"
        ],
        fixCorrectIndex: 0,
        feedback: [
          "Мы заметили, что хороший алгоритм должен не только начинаться, но и правильно завершаться.",
          "После исправления робот уже не оставил бы воду включенной."
        ],
        question: "Почему конец плана тоже нужно проверять очень внимательно?",
        aiLink: "Алгоритму важно не только начать действие, но и корректно его завершить."
      },
      {
        id: "bug-tea",
        title: "Приготовление чая",
        type: "bug-hunt",
        note: "Иногда в плане не хватает не одного, а сразу нескольких смысловых шагов.",
        steps: ["Налей воду в чайник.", "Включи чайник.", "Налей в чашку."],
        detectPrompt: "Чего не хватает, чтобы чай действительно получился?",
        detectOptions: [
          "Не хватает чайного пакетика и времени на заваривание.",
          "Все уже идеально.",
          "Нужно сначала спрятать чашку."
        ],
        detectCorrectIndex: 0,
        fixPrompt: "Какой вариант плана теперь выглядит правильно?",
        fixOptions: [
          "Налей воду в чайник -> Включи чайник -> Положи пакетик в чашку -> Налей воду в чашку -> Подожди",
          "Налей воду в чашку -> Уходи -> Включи чайник",
          "Включи чайник -> Сразу пей чай -> Потом найди чашку"
        ],
        fixCorrectIndex: 0,
        feedback: [
          "Мы добавили недостающие промежуточные шаги.",
          "Теперь инструкция стала не короткой, а действительно полезной."
        ],
        question: "Почему иногда слишком короткий план хуже, чем чуть более длинный?",
        aiLink: "Если между шагами большие пробелы, система может сделать формально верно, но не то, что мы хотели."
      },
      {
        id: "bug-road",
        title: "Переход через дорогу",
        type: "bug-hunt",
        note: "Иногда одного обычного правила недостаточно: нужны условия и исключения.",
        steps: ["Дождись зеленого света.", "Иди."],
        detectPrompt: "В каком случае такая инструкция может оказаться опасной?",
        detectOptions: [
          "Если едет скорая с сиреной.",
          "Если на улице облака.",
          "Если рядом растет дерево."
        ],
        detectCorrectIndex: 0,
        fixPrompt: "Какой план будет осторожнее и умнее?",
        fixOptions: [
          "Дождись зеленого света -> Посмотри, не едет ли спецмашина -> Иди",
          "Дождись зеленого света -> Беги не глядя",
          "Иди сразу, если скучно ждать"
        ],
        fixCorrectIndex: 0,
        feedback: [
          "Мы увидели, что иногда обычного правила мало.",
          "Нужно добавить условие, которое защищает от особого случая."
        ],
        question: "Почему некоторые планы нельзя строить только на одном простом правиле?",
        aiLink: "Иногда системе мало одного общего правила, ей нужны условия и исключения."
      }
    ]
  }
};
